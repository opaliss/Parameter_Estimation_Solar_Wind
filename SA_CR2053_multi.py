...
if __name__ == "__main__":
    ...
    # get samples
    # size [N, d]
    A = np.load("SA_results/CR" + str(CR) + "/LHS/samples/A_sample_scaled_10000.npy")
    # size [N, d]
    B = np.load("SA_results/CR" + str(CR) + "/LHS/samples/B_sample_scaled_10000.npy")
    # size [d, N, d]
    C = np.load("SA_results/CR" + str(CR) + "/LHS/samples/C_sample_scaled_10000.npy")
    # size [d, N, d]
    D = np.load("SA_results/CR" + str(CR) + "/LHS/samples/D_sample_scaled_10000.npy")
